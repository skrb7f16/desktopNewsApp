...
type='sports'
apiKey= '5b9ff0bf246741389fee11e0a2cb6245'
...
class NewsApp:
    ...
    def __init__(self,root):
        ...
        title = Label(self.root, text="NewsPaper Software", font=("times new roman", 30,"bold"), pady=2, bd=12, relief=GROOVE, bg=bg_color, fg=basic_font_color).pack(fill=X)

        #=======First frame======#
        F1=LabelFrame(self.root,text="Category",font=("times new roman",20,"bold"),bg=bg_color,fg=basic_font_color,bd=10,relief=GROOVE)
        ...
        self.txtarea=Text(F2,yscrollcommand=scroll_y.set,font=("times new roman",15,"bold"),bg=text_area_bg,fg="#3206b8")
